...
"""
    ...
    Same as calc_abmag.py, but interpolates the spectra and passbands
    with a much finer wavelength binsize (0.1A instead of 1.0A).

    Examples:

    calc_abmag.fine.py --help

    calc_abmag.fine.py --bandList g,r,i,z,Y --bandpassFile DES_STD_BANDPASSES_Y3A2_ugrizY.test.csv --spectrumFile SSSJ0006-5346_sum_bestfit.csv --colname_wave wave --colname_flux flux --flux_type Flam --verbose 1
...
def calc_abmag(args):
    ...
    delta_wavelength = 0.1 # angstroms
